...
function questionDisplayHtml(q){
  ...
  return ["Y6","Y7"].includes(selectedSet?.year)&&selectedSet?.paper==="Arithmetic"?formatY6ArithmeticFractions(base):base;
}
