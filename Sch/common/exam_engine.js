...
function questionDisplayHtml(q){
  ...
  return (["Y6","Y7"].includes(selectedSet?.year)&&selectedSet?.paper==="Arithmetic")||(selectedSet?.year==="Y8"&&selectedSet?.paper==="Mathematics")?formatY6ArithmeticFractions(base):base;
}
